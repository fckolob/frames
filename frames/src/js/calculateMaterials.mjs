...
export default class calculateMaterials{
    ...
    classificateFrames(){
        this.openings.forEach(opening => {
            ...
            if(opening.serie === "s20" && opening.color === "anodizado"){
                ...
                this.horizontalFramesS20Anodizado.push(opening.horizontalFrame);

                this.verticalFramesS20Anodizado = [];
                this.verticalFramesS20Anodizado.push(opening.verticalFrame);

                this.lateralShashesS20Anodizado = [];
                this.lateralShashesS20Anodizado.push(opening.lateralShash);

                this.centralShashesS20Anodizado = [];
                this.centralShashesS20Anodizado.push(opening.centralShash);

                this.horizontalShashesS20Anodizado = [];
                this.horizontalShashesS20Anodizado.push(opening.horizontalShash);

                this.screenShashesS20Anodizado = [];
                this.screenShashesS20Anodizado.push(opening.screenShash);
            ...
            if(opening.serie === "s25" && opening.color === "anodizado"){
                ...
                this.inferiorFramesS25Anodizado = [];
                this.inferiorFramesS25Anodizado.push(opening.inferiorFrame);

                this.superiorFramesS25Anodizado = [];
                this.superiorFramesS25Anodizado.push(opening.superiorFrame);

                this.verticalFramesS25Anodizado = [];
                this.verticalFramesS25Anodizado.push(opening.verticalFrame);

                this.lateralShashesS25Anodizado = [];
                this.lateralShashesS25Anodizado.push(opening.lateralShash);

                this.centralShashesS25Anodizado = [];
                this.centralShashesS25Anodizado.push(opening.centralShash);

                this.bigHorizontalShashesS25Anodizado = [];
                this.bigHorizontalShashesS25Anodizado.push(opening.bigHorizontalShash);

                this.smallHorizontalShashesS25Anodizado = [];
                this.smallHorizontalShashesS25Anodizado.push(opening.smallHorizontalShash);

                this.screenShashesS25Anodizado = [];
                this.screenShashesS25Anodizado.push(opening.screenShash);
            }
        });
    }
    ...
    this.framesArrays.forEach(frameArray => {
        if(frameArray !== null){
        let bar1 = new bar(this.calculateFrameBarsQuantity(this.calculateLenghtGroups(frameArray)), frameArray[0].name, frameArray[0].serie, frameArray[0].color, frameArray[0].code);
